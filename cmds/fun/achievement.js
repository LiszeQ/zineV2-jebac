...
module.exports.run = async (message, args, client) => {
    ...
    if (!tekst) return client.embeds.argsError(message, client.lang.handle(message, this.help.usageen, this.help.usagepl))
        ...
        const data = await fetch('https://api.alexflipnote.dev/achievement?text=' + tekst + '&icon=' + int, {
            method: 'GET',
        ...
        .setTitle('<a:yes:787665605464424468> Achievement')
        .attachFiles(att)
...
module.exports.help = {
    name: 'achievement',
    descriptionpl: 'Generator achievement w Minecraft.',
    descriptionen: 'MC achievement generator.',
    usageen: 'achievement [icon number] <text>',
    usagepl: 'achievement [numer ikony] <tekst>',
    category: 'Zabawa',
}
module.exports.conf = {
    aliases: ['ach'],

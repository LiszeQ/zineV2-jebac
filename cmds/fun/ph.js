...
module.exports.run = async (message, args, client) => {
    ...
    if (!tekst || !args[0] || !args[1]) return client.embeds.argsError(message, client.lang.handle(message, this.help.usageen, this.help.usagepl))
        ...
        const data = await fetch('https://api.alexflipnote.dev/pornhub?text=' + String(args[0]) + '&text2=' + String(args[1]), {
            method: 'GET',
        ...
        .setTitle('<a:yes:787665605464424468> PH logo')
        .attachFiles(att)
...
module.exports.help = {
    name: 'ph',
    descriptionpl: 'Generator loga PH.',
    descriptionen: 'PH logo generator.',
    usageen: 'ph <text1 %% text2>',
    usagepl: 'ph <tekst 1 %% tekst 2>',
    category: 'Zabawa',
    permsLevel: 1,
}
module.exports.conf = {
    aliases: ['pornhub', 'pornhublogo', 'phlogo'],
}